        ...
        <div className='container f_flex top'>
          <div className='left top'>
            ...
            <h2>
              a
              <span>
                <Typewriter words={["Jr. MERN Stack Developer.", " Jr. Frontend Developer (react.Js)"]} loop cursor cursorStyle='..' typeSpeed={70} deleteSpeed={50} delaySpeed={500} />
              </span>
            </h2>
         ...
         <a target ="_blank " href="https://drive.google.com/file/d/1ILTu_dPTHIjFvFq3gP0sXYbdhM5H1ztt/view?usp=sharing" ><Button className="btn btn-warning fw-bold mt-5">Resume</Button></a>
            <p>Hi, My name's MD Shakib Ahamed . I am a student Southwest Forestry University which is located in Yunnan Province, China. My major is Computer Science and Technology. When I was in first year I started coding & then I loved to do coding and I wanted to be a web developer. During my spare time, I used to watch coding concepts and how to make websites. And I planned to do some work included with web development and I made a few projects according to the web development.And now I am good at Html5, Css3, React.Js, Bootstrap, Tailwind, React Router, Rest API , Node.Js, Express.Js, MongoDB,Firebase, Stripe. 
And I have to plan learn Python and Django & Also php . So Now I want to join A Farm as a Developer as i can learn new features and i can Develop my skill and can utilize my Current skills </p>
